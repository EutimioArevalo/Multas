...
import Controlador.ControladorListaLicencias;
import Controlador.ListaLicencia;
import Vista.componentes.tablaLicencias;
...
public class LICENCIAS extends javax.swing.JFrame {
    tablaLicencias tl = new tablaLicencias();
    ListaLicencia ll = new ListaLicencia();
    ControladorListaLicencias lista = new ControladorListaLicencias();
    /**
    ...
    public void cargarTabla(){
        tl.setLista(lista.getLista());
        
        jTable1.setModel(tl);
        tl.ajustarTabla(jTable1);
        jTable1.updateUI();
